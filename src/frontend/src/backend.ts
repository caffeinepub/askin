...
import type { Answer as _Answer, Doubt as _Doubt, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllDoubts(): Promise<Array<[Principal, Doubt]>> {
        if (this.processError) {
            try {
    ...
    async getAnswersForDoubt(arg0: Principal): Promise<Array<[Principal, Answer]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAnswersForDoubt(arg0);
    ...
    async postAnswer(arg0: Principal, arg1: string, arg2: ExternalBlob | null, arg3: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.postAnswer(arg0, arg1, await to_candid_opt_n27(this._uploadFile, this._downloadFile, arg2), await to_candid_opt_n27(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async postDoubt(arg0: string, arg1: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.postDoubt(arg0, await to_candid_opt_n27(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rateAnswer(arg0: Principal, arg1: Principal, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rateAnswer(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Answer_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Answer): Promise<Answer> {
    return await from_candid_record_n19(_uploadFile, _downloadFile, value);
}
async function from_candid_Doubt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Doubt): Promise<Doubt> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        attachment: record_opt_to_undefined(await from_candid_opt_n14(_uploadFile, _downloadFile, value.attachment))
    };
}
async function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        notes: record_opt_to_undefined(await from_candid_opt_n14(_uploadFile, _downloadFile, value.notes)),
        rating: value.rating
    };
}
...
async function from_candid_tuple_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _Doubt]): Promise<[Principal, Doubt]> {
    return [
        value[0],
        await from_candid_Doubt_n12(_uploadFile, _downloadFile, value[1])
    ];
}
async function from_candid_tuple_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _Answer]): Promise<[Principal, Answer]> {
    return [
        value[0],
        await from_candid_Answer_n18(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _Doubt]>): Promise<Array<[Principal, Doubt]>> {
    return await Promise.all(value.map(async (x)=>await from_candid_tuple_n11(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _Answer]>): Promise<Array<[Principal, Answer]>> {
